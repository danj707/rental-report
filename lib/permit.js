...
const CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .meta { font-size:15px; color:#222; line-height:1.6; max-height:1.5in; overflow:hidden; }
  .meta b { color:#000; }
    ...
    + '<div class="body">'
      + '<div class="left">'
        ...
        + '<div class="meta">'
          ...
          + (s.details ? `<b>Conditions:</b> ${esc(clamp(s.details, 260))}` : "")
        + '</div>'
      + '</div>'
      + '<div class="right">'
        + '<div class="qrbox">'
...
module.exports = { toHtml, sheet, longDate, timeRange, esc, clamp };
