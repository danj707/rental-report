...
--
-- ⚠ THE LIVE CARD DOES NOT HAVE THE TWO FIXES BELOW. Apply them IN THE UI —
...
--
-- Hilltop never appears: it has no bookable aquatic site (picnic tables only).
...
aquatic_sites AS (
  -- ▼▼ THE OTHER LINE TO EDIT when a pool or location is added ▼▼
  SELECT c.id, c.court_number AS lane, l.name AS loc
  FROM court c
